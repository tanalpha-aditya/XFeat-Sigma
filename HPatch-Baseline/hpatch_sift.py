...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Run HPatches homography estimation experiment with SIFT.')
    ...
    run_hpatches_experiment(args.hpatches_path, 'sift', args.output)
