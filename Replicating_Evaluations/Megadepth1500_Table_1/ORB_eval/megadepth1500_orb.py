...
def parse_args():
    ...
    parser.add_argument('--matcher', type=str, choices=['xfeat', 'xfeat-star', 'alike', 'orb'], default='orb',
                    help="Matcher to use (xfeat, xfeat-star, alike, or orb)")
...
if __name__ == '__main__':
    ...
    if args.matcher == 'xfeat':
        ...
        print("Running benchmark for ORB (OpenCV)..")
        run_pose_benchmark(matcher_fn = match_orb, loader = loader, ransac_thr = args.ransac_thr)
